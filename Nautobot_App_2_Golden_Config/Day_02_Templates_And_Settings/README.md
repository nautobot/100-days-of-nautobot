...
![cEOS Lab Devices DynamicGroup detail page with the Platform = arista_eos filter applied](../images/day2_dynamic_group.png)

![Members tab of the cEOS Lab Devices DynamicGroup listing the four mock cEOS Devices (bos-acc-01, bos-rtr-01, nyc-acc-01, nyc-rtr-01)](../images/day2_dynamic_group_members.png)
